...
class Queue {
    ...
    enqueue(value) {
        ...
        if (this.first) {
            // If there is already an item in the queue, set the node of the queue's next pointer to be the new node
            this.last.next = newNode;
        } else {
            // If there are no items in the queue, set the first item to be the new node
            this.first = newNode;
        }
